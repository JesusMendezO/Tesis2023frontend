...
//  console.log(datos[0].attributes.id)
  return (
    ...
    <>
       ...
       <h1 className='text-white uppercase text-4xl text-center text-4xl font-["Rumble_Brave"] mt-4'>Iglesia Santa Barbara</h1>
       </div>
       
    
          
       <div class="grid justify-items-center mt-20">
  <div><iframe className='' src="https://tourmaline-piroshki-0bcca4.netlify.app/" width={1000} height={400} allowfullscreen="true"></iframe> </div>
...
export default RecorridoIglesia